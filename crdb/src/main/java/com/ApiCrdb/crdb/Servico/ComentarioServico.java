...
import com.ApiCrdb.crdb.Repositorios.ComentarioRepositorio;
...
public class ComentarioServico {
	...
	public Comentario deletarComentario(String token, Long id) {
		...
		throw new ComentarioExcecao("Não pode apagar comentarios de outra pessoa");
	...
	public Comentario deletar(String token, Long id) {
		...
		for (Comentario c : comentarioBD.findAll()) {
			...
			throw new ComentarioExcecao("Voce não pode apagar comentarios de outras pessoas");
